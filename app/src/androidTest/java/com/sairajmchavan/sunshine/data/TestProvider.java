 ...
 */
package com.sairajmchavan.sunshine.data;
...
public class TestProvider extends AndroidTestCase {
    ...
    public void testBasicWeatherQuery() {
        ...
        long weatherRowId = db
                .insert( WeatherContract.WeatherEntry.TABLE_NAME, null, weatherValues );
    ...
    public void testBasicLocationQueries() {
        ...
        // Make sure we get the correct cursor out of the database
        TestUtilities.validateCursor( "testBasicLocationQueries, location query", locationCursor,
                testValues );
    ...
    public void testInsertReadProvider() {
        ...
        Uri locationUri = mContext.getContentResolver()
                                  .insert( WeatherContract.LocationEntry.CONTENT_URI, testValues );
        ...
        Uri weatherInsertUri = mContext.getContentResolver()
                                       .insert( WeatherContract.WeatherEntry.CONTENT_URI,
                                               weatherValues );
        ...
        TestUtilities
                .validateCursor( "testInsertReadProvider. Error validating WeatherEntry insert.",
        ...
        weatherCursor = mContext.getContentResolver().query(
                WeatherContract.WeatherEntry
                        .buildWeatherLocationWithDate( TestUtilities.TEST_LOCATION,
    ...
    public void testDeleteRecords() {
        ...
        mContext.getContentResolver()
                .registerContentObserver( WeatherContract.LocationEntry.CONTENT_URI, true, locationObserver );

        // Register a content observer for our weather delete.
        TestUtilities.TestContentObserver weatherObserver = TestUtilities.getTestContentObserver();
        mContext.getContentResolver()
                .registerContentObserver( WeatherContract.WeatherEntry.CONTENT_URI, true, weatherObserver );
    ...
    static ContentValues[] createBulkInsertWeatherValues(long locationRowId) {
        ...
        for (int i = 0; i < BULK_INSERT_RECORDS_TO_INSERT; i++, currentTestDate
            ...
            weatherValues
                    .put( WeatherContract.WeatherEntry.COLUMN_HUMIDITY, 1.2 + 0.01 * (float) i );
            weatherValues
                    .put( WeatherContract.WeatherEntry.COLUMN_PRESSURE, 1.3 - 0.01 * (float) i );
            ...
            weatherValues
                    .put( WeatherContract.WeatherEntry.COLUMN_WIND_SPEED, 5.5 + 0.2 * (float) i );
